...
const About = () => {
    const [ThemeStyleText, changeThemeStyleText] = useState("Light Mode")
  ...
  let  toggleStyle= ()=>{
        if(myStyle.color==='white' && myStyle.backgroundColor==='black'){
            ...
            changeThemeStyleText("Dark Mode")
        }
        else{
            setMyStyle({
                color:'white',
            ...
            changeThemeStyleText("Light Mode")
        }
    }
        ...
        return <div className='container' style={myStyle}>
                ...
                <div className="container my-3">
                    <button onClick={toggleStyle} type="button" className="btn btn-primary">{ThemeStyleText}</button>
                </div>
            </div>;
}
